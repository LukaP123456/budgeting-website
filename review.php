...
<section id="instructors" class="p-5" style="background: url('./img/okean2.jpg'); background-size: cover;">
    <div class="container">
        ...
        <p class="lead text-center text-white mb-5">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad architecto cum dolores id magni maxime quia
            recusandae sapiente suscipit vel!
        </p>
        <div class="row g-4">
            <div class="col-md-6 col-lg-3">
                <div class="card bg-light">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum enim est
                            eveniet minima ratione, similique!</p>

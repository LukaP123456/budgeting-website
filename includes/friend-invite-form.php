            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header bg-dark text-white">
                        <h5>You have been invited by <span
                                    class="text-warning"> <?php echo $_SESSION["users_email"]; ?> </span> to save money
                            on our website.</h5>
                        <p>Please fill out the form below and you will join <span
                                    class="text-warning"> <?php echo $_SESSION["users_email"]; ?> </span> in saving
                            money together </p>
                    </div>
                    <div class="card-body">
                        <form action="reset-request.php" id="friend-invite-form" method="POST">

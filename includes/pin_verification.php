                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-black text-white">
                            ...
                            <p>Please check your email account and enter the number you received</p>
                        </div>
                        <div class="card-body">
                            <?php
                            session_start();
                            ...
                            if (strpos($fullUrl, "error=pin_invalid") == true) {
                        ...
                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                            ...
                            ?>
                            <form action="pin_verify.php" id="reset-request-form" method="POST">
                                <div class="form-group mb-3">
                                    <label for="email">Email address</label>
                                    <input type="text" id="PIN" name="PIN" class="form-control"
                                           placeholder="Enter PIN">
<!--                                    <small class="message" id="message-PIN"></small>-->
                                </div>
                                <div class="form-group mb-3">
                                    <button type="submit" name="PIN-submit" class="btn btn-primary">Submit
                                    </button>
                                </div>
